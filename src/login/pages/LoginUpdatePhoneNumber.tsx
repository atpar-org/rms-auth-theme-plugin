...
export default function LoginUpdatePhoneNumber(
    props: PageProps<Extract<KcContext, { pageId: "login-update-phone-number.ftl" }>, I18n>
) {
    ...
    return (
        <Template
            ...
            classes={classes}
            headerNode={safeMsg(i18n, "updatePhoneNumber", "Update phone number")}
            displayInfo={true}
            infoNode={safeMsg(i18n, "updatePhoneNumberInfo", "")}
